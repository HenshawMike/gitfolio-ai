...
export default function Dashboard({ user, repos }: DashboardProps) {
    ...
    const currentGenStepIndex = Math.min(Math.floor((genProgress / 100) * genSteps.length), genSteps.length - 1);
                ...
                {step === 'generating' ? (
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <h2 className="text-2xl font-bold text-white">Magically building your portfolio...</h2>
                            <div className="max-w-md mx-auto space-y-4">
                                ...
                                <div className="flex flex-col items-start gap-3">
                                    {genSteps.map((s, i) => (
                                        <div
                                            key={s.label}
                                            className={`flex items-center gap-3 transition-colors ${i <= currentGenStepIndex ? 'text-blue-400' : 'text-white/20'}`}
                                        >
                                            {i < currentGenStepIndex ? <CheckCircle className="w-5 h-5" /> : s.icon}
                    ...
                    >
                        ...
                        <h2 className="text-3xl font-bold text-white">Your portfolio is ready!</h2>
                        <p className="text-blue-200/60">We've turned your GitHub projects into a professional showcase.</p>
                        <button className="px-8 py-4 bg-white text-black font-bold rounded-2xl hover:bg-blue-50 transition-colors shadow-xl shadow-white/10 flex items-center gap-2 mx-auto">
